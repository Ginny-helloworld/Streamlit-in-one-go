...
df=pd.read_csv('/Users/ginnyshai/Desktop/lib/streamlit/lang_data.csv')
...
df=pd.read_csv('/Users/ginnyshai/Desktop/lib/streamlit/tips.csv')
...
fig1=px.pie(df, values='tip',names='size')
st.plotly_chart(fig1)


st.subheader("3.2 Pie chart whith multiple parameters")
